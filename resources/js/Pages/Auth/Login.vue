    ...
    <form @submit.prevent="submit" class="space-y-5">
        ...
        <div class="flex items-center justify-between">
            <label class="inline-flex items-center">
                <input v-model="form.remember" type="checkbox" class="rounded border-gray-300 text-orange-500 focus:ring-orange-500">
                <span class="ml-2 text-sm text-gray-600">Lembrar-me</span>
            </label>
            <Link :href="route('password.request')" class="text-sm text-orange-500 hover:text-orange-600 font-medium">Esqueceu a palavra-passe?</Link>
        </div>
        ...
        <p class="text-center text-sm text-gray-500">
            Não tem conta? <Link :href="route('register')" class="text-orange-500 hover:text-orange-600 font-semibold">Registar-se</Link>
        </p>
    </form>
</template>
