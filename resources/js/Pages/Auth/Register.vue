...
<template>
    ...
    <form @submit.prevent="submit" class="space-y-5">
        <div>
            ...
            <input v-model="form.name" type="text" required autofocus placeholder="O seu nome"
        ...
        <p class="text-center text-sm text-gray-500">
            Já tem conta? <Link :href="route('login')" class="text-orange-500 hover:text-orange-600 font-semibold">Entrar</Link>
        </p>
    </form>
</template>
